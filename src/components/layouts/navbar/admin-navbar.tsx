          ...
          <div className="p-6">
            ...
            >
              <div className="flex gap-x-4 items-center">
                ...
                <p className="capitalize font-medium text-sm">Dashboard</p>
              </div>
            </CustomLink>
            <CustomLink
              href="#"
            ...
            >
              <div className="flex gap-x-4 items-center">
                ...
                <p className="capitalize font-medium text-sm">Pesan</p>
              </div>
            </CustomLink>
            <CustomLink
              href="#"
            ...
            >
              <div className="flex gap-x-4 items-center">
                ...
                <p className="capitalize font-medium text-sm">Reservasi</p>
              </div>
            </CustomLink>
            <CustomLink
              href="#"
            ...
            >
              <div className="flex gap-x-4 items-center">
                ...
                <p className="capitalize font-medium text-sm">Peminjam</p>
              </div>
            </CustomLink>
            <CustomLink
              href="#"
            ...
            >
              <div className="flex gap-x-4 items-center">
                ...
                <p className="capitalize font-medium text-sm">Meja</p>
              </div>
            </CustomLink>
          </div>
        </WhiteCard>
