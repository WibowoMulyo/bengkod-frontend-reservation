  ...
  return (
    <div className="bg-blue-900 flex flex-col text-white md:relative">
      ...
      <div className="flex flex-col w-full items-center justify-center md:my-2">
        ...
        <div className="my-6 text-xs flex items-center justify-center md:text-lg">
          Copyright © 2024. Bengkel Koding
        </div>
      </div>
      ...
      <div className="hidden md:block">
        <img
          className="left-0 bottom-0 absolute w-56"
          src="./image/bg-left-bottom.png"
          alt=""
        />
        <img
          className="right-0 top-0 absolute w-56"
          src="./image/bg-right-top.png"
          alt=""
        />
      </div>
    </div>
