...
const navbar = () => {
  return (
    <header className="md:m-4 m-2 md:border-gray-200 md:rounded-3xl md:border-[3px]">
      <div className="hidden items-center md:flex mx-[5%]">
        ...
        <div className="hidden lg:flex md:justify-between md:text-[16px] text-primary-900 font-semibold gap-x-[100px]">
      ...
      <div className="flex md:hidden flex-wrap items-center justify-between p-2">
        <ResponsiveImage
          ...
          height={40}
          alt="logo bengkod"
          className="md:hidden block w-[160px] h-[40px]"
        />
        {/* <button
        ...
        <div className="dropdown dropdown-bottom dropdown-end">
          ...
          <ul
            tabIndex={0}
            className="dropdown-content menu bg-base-100 z-[1] w-52 p-2"
          >
            <li>
              <a>Daftar</a>
            </li>
