...
// Daftar tanggal untuk setiap hari dalam seminggu
                ...
                <div className="mx-auto my-10 flex flex-col">
                    ...
                    <div className="mt-6">
                        <button className="w-full">
                            <div className="bg-[#1e3a8b] rounded-lg p-4 flex gap-x-4 items-center">
                                ...
                                <p className="capitalize text-white font-medium text-sm">kalender</p>
                            </div>
                        </button>
                        <button>
                            <div className="rounded-lg p-4 flex gap-x-4 items-center">
                                ...
                                <p className="capitalize text-black font-medium text-sm">kalender</p>
                            </div>
                        </button>
                    </div>
