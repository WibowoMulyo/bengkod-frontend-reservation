    ...
    <div className="md:flex block md:mt-[3.5%] mb-[6%] lg:mx-8 mx-auto">
      ...
      <div className="flex flex-col w-[250px]">
        <div className="text-center">
          <h1 className="text-[#6b7a99] font-bold capitalize text-2xl text-wrap">
            halo, kaoruko waguri!
          </h1>
          <p className="text-[#adb8cc] font-bold text-xs mt-2">
            examplemhs@mhs.dinus.ac.id
          </p>
        </div>
        <div className="bg-white rounded-xl p-3 mt-8 md:mx-4  shadow-[1px_5px_50px_4px_rgba(0,0,0,0.05)] lg:shadow-none mx-auto">
          <div className="flex w-full">
            <div className="mr-auto">
              <h1 className="text-[#202224] font-normal text-sm">
                Total reservation
              </h1>
            ...
            >
              <path
                ...
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M46.7864 23.1144C46.7864 35.7621 36.5334 46.0152 23.8856 46.0152C11.2379 46.0152 0.984863 35.7621 0.984863 23.1144C0.984863 10.4666 11.2379 0.213623 23.8856 0.213623C36.5334 0.213623 46.7864 10.4666 46.7864 23.1144Z"
                fill="#8280FF"
              />
              <path
                opacity="0.587821"
          ...
          <div className="flex gap-x-1.5 text-xs mt-8 items-center">
            ...
            >
              <path
                d="M11.4277 0.946533L13.1758 2.69462L9.45065 6.41982L6.39721 3.36638L0.740723 9.0305L1.81706 10.1068L6.39721 5.52669L9.45065 8.58012L14.2598 3.77859L16.0079 5.52669V0.946533H11.4277Z"
                fill="#00B69B"
              />
            </svg>
            ...
            <div className="flex gap-x-3 w-full items-center">
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M1 9.49336H12.17L7.29 14.3734C6.9 14.7634 6.9 15.4034 7.29 15.7934C7.68 16.1834 8.31 16.1834 8.7 15.7934L15.29 9.20336C15.68 8.81336 15.68 8.18336 15.29 7.79336L8.71 1.19336C8.52317 1.00611 8.26952 0.900879 8.005 0.900879C7.74048 0.900879 7.48683 1.00611 7.3 1.19336C6.91 1.58336 6.91 2.21336 7.3 2.60336L12.17 7.49336H1C0.45 7.49336 0 7.94336 0 8.49336C0 9.04336 0.45 9.49336 1 9.49336Z"
                  fill="#C3CAD9"
                />
              </svg>
            </div>
