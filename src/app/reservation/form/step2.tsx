                ...
                <div className="">
                    ...
                    <div className="my-5">
                        ...
                        <div className="flex">
                            ...
                            <div className="w-[40%] mr-auto flex flex-col">
                                <div className="bg-white rounded-xl px-8 py-6 text-black border-black/[.3] border-2 font-normal mb-4">
                                    <p>Gambar Meja yang Dipilih</p>
                                </div>

                                <div className="bg-white px-8 pt-8 pb-4 rounded-xl text-center">
                                    <img src="/image/table_img/table1.jpeg" alt="" className="rounded-xl w-full mb-2" />
                                    <h1 className="font-bold">Table-01</h1>
                                </div>
                            </div>
                            {/* END SECTION GAMBAR MEJA */}
                            {/* START SECTION CALENDAR */}
                            <div className="w-[55%] flex flex-col">
                                <div className="bg-white rounded-xl px-8 py-6 text-black border-black/[.3] border-2 font-normal italic mb-4">
                                    <p>Pilih Waktu yang Tersedia</p>
                                </div>
